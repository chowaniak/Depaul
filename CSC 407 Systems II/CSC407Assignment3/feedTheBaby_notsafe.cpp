...
//		Compile with:
//			g++ feedTheBaby_notsafe.cpp -o ftb -lpthread
...
This is what happens e.g.:

Too many threads created, name of food gets repeated 
which sugests that program is not able to randomly choose food name from array
or the same thread is being duplicated
...
yogurt is being held up in the large intestine
yogurt is being held up in the large intestine
yogurt is being held up in the large intestine
yogurt is being held up in the large intestine
yogurt is being held up in the large intestine
